...
public class android_touchpad extends View {
    ...
    public interface Listener {
        ...
        void onTrackpadEvent(int i);
    }

    public class RepeatHandler extends Handler {
        static final int MESSAGE_REPEAT = 0;

        RepeatHandler(android_touchpad trackpadView, RepeatHandler repeatHandler) {
            this();
        }
        ...
        public void handleMessage(Message message) {
            switch (message.what) {
                case 0:
                    android_touchpad.this.sendEvent(android_touchpad.this.mSwipeDirection, false);
                    removeMessages(0);
                    if (android_touchpad.this.mCurrentRepeatPeriod > 0) {
                        sendEmptyMessageDelayed(0, (long) android_touchpad.this.mCurrentRepeatPeriod);
                        return;
                    }
                    return;
                default:
    ...
    public android_touchpad(Context context, AttributeSet attributeSet) {
    ...
    private void sendEvent(int i, boolean z) {
        switch (i) {
            case 0:
                ...
                return;
            case 1:
                this.mListener.onTrackpadEvent(21);
                return;
            case 2:
                this.mListener.onTrackpadEvent(22);
                return;
            case 3:
                this.mListener.onTrackpadEvent(19);
                return;
            case 4:
                this.mListener.onTrackpadEvent(20);
                return;
            default:
                return;
        }
